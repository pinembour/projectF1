...
F1Game game;
	...
	private Stage stage;
	private Skin skin;
	private TextButton buttonRestart,buttonMainMenu;
	...
	public GameOverScreen(F1Game game, int level) {
	...
	public void show() {
		...
		buttonMainMenu.setPosition(buttonAxeX - buttonMainMenu.getWidth()*buttonScale / 2, buttonAxeY - buttonRestart.getHeight() * buttonScale - buttonSpacing );
